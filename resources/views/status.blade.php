			         ...
			         <div class="elementor-widget-wrap elementor-element-populated">
                           ...
                           <style>
                              ...
                              * {
                              ...
                              .welcome {
                              height: 100vh;
                              background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(https://tanknewsinternational.com/wp-content/uploads/2021/10/Storage-1335076487-copy1-scaled-1.jpg) center/cover no-repeat;
                              display: flex;
                              ...
                              <header>
                                    ...
                                    <nav class="nav-container">
                                       <ul class="top-side">
                                         ...
                                         <li><a href="error">ERROR</a></li>&emsp;&emsp;&emsp;
                                         <li><a href="status" class="selected">STATUS</a></li>&emsp;&emsp;&emsp;
                                 ...
                                 <div class="welcome-content">&emsp;&emsp;&emsp;
                                    <h1>Welcome to</h1>&emsp;&emsp;&emsp;
                                    <h1>Ceylon Petroleum Corporation</h1>&emsp;&emsp;&emsp;
                                    <p>We provide a range of high-quality petroleum products and services.</p>&emsp;&emsp;&emsp;
                                 </div>&emsp;&emsp;&emsp;
                              </div>&emsp;&emsp;&emsp;
                           </section>
                        </div>
